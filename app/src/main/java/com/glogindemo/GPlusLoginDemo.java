...
public class GPlusLoginDemo extends AppCompatActivity implements
        View.OnClickListener,
        GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = GPlusLoginDemo.class.getSimpleName();
    ...
    private void updateUIAfterLoginLogout(boolean isSignedIn) {
        if (isSignedIn) {
